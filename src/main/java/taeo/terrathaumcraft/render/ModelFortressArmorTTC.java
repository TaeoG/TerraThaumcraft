...
public class ModelFortressArmorTTC
		extends ModelPlayer
{
	...
	public ModelFortressArmorTTC(float f)
	{
		//super(f, 0.0F, 128, 64);
		super(f);
		...
		/**try {
		 Field modelField = this.getClass().getDeclaredField("model");
		 modelField.setAccessible(true);

		 modelField.set(this, new SmartRenderModel(this, this, bipedBody, bipedCloak, bipedHead, bipedEars, bipedHeadwear, bipedRightArm, bipedLeftArm, bipedRightLeg, bipedLeftLeg));
 ...
 * Qualified Name:     thaumcraft.client.renderers.models.gear.ModelFortressArmor
