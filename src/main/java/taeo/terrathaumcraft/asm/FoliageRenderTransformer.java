...
public class FoliageRenderTransformer extends TAPITransformer {
    @Override
    public byte[] transform(String name, String transformedName, byte[] basicClass)
    {
        if(name.equals("com.bioxx.tfc.Blocks.Vanilla.BlockCustomLeaves") || name.equals("com.bioxx.tfc.Blocks.Vanilla.BlockCustomVine"))
        {
            LogHelper.info(ReferenceTTC.MOD_NAME,"FOUND TFC CUSTOMLEAVES CLASS");
    ...
    {
        LogHelper.info(ReferenceTTC.MOD_NAME,"Patching Leaf and Vine Render");
        ...
        while(methods.hasNext())
        {
            ...
            if (meth.name.equals(targetMethod))
            {
                ...
                meth.visitMethodInsn(INVOKESTATIC, "taeo/terrathaumcraft/utility/ColorTools", "foliageColorMultiplier", "(Lnet/minecraft/world/IBlockAccess;III)I", false);
                meth.visitInsn(IRETURN);
                Label l1 = new Label();
                meth.visitLabel(l1);
                meth.visitLocalVariable("this", "Lterrathaumcraft/block/Foliage/BlockCustomLeavesTTC;", null, l0, l1, 0);
