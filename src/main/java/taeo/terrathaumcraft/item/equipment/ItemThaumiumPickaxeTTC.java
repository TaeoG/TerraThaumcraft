...
public class ItemThaumiumPickaxeTTC extends ItemCustomPickaxe implements IRepairable{

	public ItemThaumiumPickaxeTTC() {
		super(TTCItems.ThaumiumEnhancedToolMaterial);
		this.setUnlocalizedName("thaumiumpickaxe");
		this.setMaxDamage(TTCItems.ThaumiumEnhancedToolMaterial.getMaxUses());
	}
	public void registerIcons(IIconRegister iconRegister)
	{
		itemIcon = iconRegister.registerIcon("thaumcraft:thaumiumpick");
	}
