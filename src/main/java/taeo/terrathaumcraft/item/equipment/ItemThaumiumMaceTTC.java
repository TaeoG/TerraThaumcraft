...
public class ItemThaumiumMaceTTC extends ItemCustomSword implements IRepairable{

	public ItemThaumiumMaceTTC() 
	{
		super(TTCItems.ThaumiumEnhancedToolMaterial, 240, EnumDamageType.CRUSHING);
