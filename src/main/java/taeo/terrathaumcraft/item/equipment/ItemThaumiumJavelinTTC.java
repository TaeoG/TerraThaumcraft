...
public class ItemThaumiumJavelinTTC extends ItemJavelin implements IRepairable{

	public ItemThaumiumJavelinTTC() {
		super(TTCItems.ThaumiumEnhancedToolMaterial, TTCItems.ThaumiumEnhancedToolMaterial.getDamageVsEntity());
	}
