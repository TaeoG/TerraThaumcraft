...
public class ItemThaumiumAxeTTC extends ItemCustomAxe implements IRepairable{

	public ItemThaumiumAxeTTC()
	{
		super(TTCItems.ThaumicSteel, 270); //270 is the damage of high tier metal
		this.setUnlocalizedName("thaumiumaxe");

	}
	
	public void registerIcons(IIconRegister iconRegister)
	{
		itemIcon = iconRegister.registerIcon("thaumcraft:thaumiumaxe");
	}
