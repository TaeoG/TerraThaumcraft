...
public class ItemThaumiumShovelTTC extends ItemCustomShovel implements IRepairable{

	public ItemThaumiumShovelTTC() {
		super(TTCItems.ThaumiumEnhancedToolMaterial);
		this.setUnlocalizedName("thaumiumshovel");
		// TODO Auto-generated constructor stub
	}
	public void registerIcons(IIconRegister iconRegister)
	{
		itemIcon = iconRegister.registerIcon("thaumcraft:thaumiumshovel");
	}
