...
public class EntityGiantBrainyZombieTTC extends EntityGiantBrainyZombie implements ICausesDamage, IInnateArmor {
    public EntityGiantBrainyZombieTTC(World world)
    {
        super(world);
    }
