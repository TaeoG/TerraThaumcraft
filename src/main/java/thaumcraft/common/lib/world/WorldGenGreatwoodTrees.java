...
public class WorldGenGreatwoodTrees extends WorldGenAbstractTree {
                ...
                while(true) {
                    ...
                    if(var15 > (double)(par4 * par4)) {
                        ...
                        try {
                            ...
                            Block e = this.worldObj.getBlock(var11[0], var11[1], var11[2]);
                            if((e == Blocks.air || e == TTCBlocks.blockMagicLeaves) && (e == null || e.canBeReplacedByLeaves(this.worldObj, var11[0], var11[1], var11[2]))) {
                            //    if((e == Blocks.air || e == ConfigBlocks.blockMagicalLeaves) && (e == null || e.canBeReplacedByLeaves(this.worldObj, var11[0], var11[1], var11[2]))) {
    ...
    void generateLeafNode(int par1, int par2, int par3) {
        ...
        for(int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, TTCBlocks.blockMagicLeaves);  //ConfigBlocks.blockMagicalLeaves);
        }
    ...
    void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, TTCBlocks.blockMagicTrunk);
        if(this.trunkSize == 2) {
            ++var5[0];
            ++var6[0];
            //this.placeBlockLine(var5, var6, ConfigBlocks.blockMagicalLog);
    ...
    void generateLeafNodeBases() {
        ...
        for(int[] var3 = new int[]{this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1) {
            ...
            if(this.leafNodeNeedsBase(var6)) {
                ...
                this.placeBlockLine(var3, var5, TTCBlocks.blockMagicTrunk);
            }
        }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
        ...
        if(var3[var5] == 0) {
            ...
            for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                ...
                try {
                    Block e = this.worldObj.getBlock(var13[0], var13[1], var13[2]);
                    if(e != Blocks.air && e != TTCBlocks.blockMagicLeaves){ //ConfigBlocks.blockMagicalLeaves) {
                        break;
                    }
                } catch (Exception var17) {
                    ;
    ...
    boolean validTreeLocation(int x, int z) {
        ...
        try {
            Block e = this.worldObj.getBlock(this.basePos[0] + x, this.basePos[1] - 1, this.basePos[2] + z);
            boolean isSoil = e.canSustainPlant(this.worldObj, this.basePos[0] + x, this.basePos[1] - 1, this.basePos[2] + z, ForgeDirection.UP, (BlockSapling)Blocks.sapling);
            if(!isSoil) {
                return false;
            } else {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5, boolean spiders) {
            ...
            for(var16 = -1; var16 < 2; ++var16) {
                for(int var17 = 0; var17 < this.trunkSize; ++var17) {
                    for(int var18 = 0; var18 < this.trunkSize; ++var18) {
                        if(!this.validTreeLocation(var17 + var14, var18 + var16)) {
                            continue label75;
                        }
                    }
                }
                ...
                valid = true;
                this.basePos[0] += var14;
                this.basePos[2] += var16;
                break label77;
            }
        }
        ...
        if(!valid) {
            ...
            if(spiders) {
                ...
                TileEntityMobSpawner var19 = (TileEntityMobSpawner)par1World.getTileEntity(par3, par4 - 1, par5);
                if(var19 != null) {
                    var19.func_145881_a().setEntityName("CaveSpider");

                    for(var16 = 0; var16 < 50; ++var16) {
                        int loot = par3 - 7 + par2Random.nextInt(14);
                        int yy = par4 + par2Random.nextInt(10);
                        int zz = par5 - 7 + par2Random.nextInt(14);
                        //if(par1World.isAirBlock(loot, yy, zz) && (BlockUtils.isBlockTouching(par1World, loot, yy, zz, ConfigBlocks.blockMagicalLeaves) || BlockUtils.isBlockTouching(par1World, loot, yy, zz, ConfigBlocks.blockMagicalLog))) {
                        if(par1World.isAirBlock(loot, yy, zz) && (BlockUtils.isBlockTouching(par1World, loot, yy, zz, TTCBlocks.blockMagicLeaves) || BlockUtils.isBlockTouching(par1World, loot, yy, zz, TTCBlocks.blockMagicTrunk))) {
                            this.worldObj.setBlock(loot, yy, zz, Blocks.web, 0, 3);
                        }
                    }

                    par1World.setBlock(par3, par4 - 2, par5, Blocks.chest, 0, 3);
                    TileEntityChest var20 = (TileEntityChest)par1World.getTileEntity(par3, par4 - 2, par5);
                    if(var20 != null) {
                        ChestGenHooks var21 = ChestGenHooks.getInfo("dungeonChest");
                        WeightedRandomChestContent.generateChestContents(this.rand, var21.getItems(this.rand), var20, var21.getCount(this.rand));
                    }
                }
            }
